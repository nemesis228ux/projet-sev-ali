...
from app.crud.transactionCrud import (
    get_all_transactions_in_bd,
    get_user_transactions,
    Transactor,
    get_user_specific_transaction,
)
from app.models.transaction import TransactionTypes
from app.schemas.transactionSchema import (
    TransactionsView,
    TransactionsFetch,
    TransactionView,
    DepotTransac,
...
def get_all_transactions(
    transac_type: Optional[TransactionTypes] = Query(
        None, description="Param de requete otionnelle pour filtrer les transactions"
    ),
...
def do_a_transfert(
    ...
    return TransactionView.error_response(
        result.error
    )  # La transac n'a pas réussi donc on renvoi une reponse d'erreur
