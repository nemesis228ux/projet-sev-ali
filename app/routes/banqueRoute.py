...
router = APIRouter(
    prefix="/banques", tags=["banques"]
)  ## instance de notre router fastapi / petite instance de notre app ☺
...
def create_a_banque(
    banque: BanqueCreate, db: Session = Depends(get_db)
) -> ApiBaseResponse[BanqueRead]:
